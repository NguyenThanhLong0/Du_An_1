...
<section class="khungaddm">
    ...
    <table class="table">
        <tr>
            <th>Mã danh mục _nam</th>
            <th>Tên danh mục _nam</th>
            <th>Thao tác</th>
        </tr>
        <?php
        foreach ($listdanhmuc_nam as $danhmuc_nam) {
            ...
            echo '<tr>
                            ...
                            <td><a href="' . $suadm_nam . '"><input type="button" value="Sửa"></a> <a href="' . $xoadm_nam . '"><input type="button" value="Xóa"></a> <a href="index.php?act=adddm_nam"><input type="button" value="Nhập thêm" /></a></td>
                        </tr>';
        }
        ?>
    </table></div>
