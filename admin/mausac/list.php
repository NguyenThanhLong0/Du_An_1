...
<section class="khungaddm">
    ...
    <div class="form-group">
            <a href="index.php?act=addms"><input type="button" value="Nhập thêm" /></a>
        </div>
        ...
        <table class="table">
            ...
            foreach ($listms as $mausac) {
                ...
                echo '<tr>
                            <td>' . $ma_mausac . '</td>
                            <td>' . $ten_mausac . '</td>
                            <td><a href="' . $suams . '"><input type="button" value="Sửa"></a> <a href="' . $xoams . '"><input type="button" value="Xóa"></a> </td>
                        </tr>';
            }
            ?>
        </table>
